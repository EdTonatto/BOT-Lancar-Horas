...
[Files]			
;Arquivos novos 
Source: ..\Projeto - Arquivos\OutrosBots\BotAtualizarOK.exe; DestDir: {sd}\banco\Servidor\; Check: MyProgCheck; Flags: ignoreversion; Languages:
...
begin
  ...
  begin
		if (FileExists('C:\banco\servidor\BotAtualizarOK.exe')) then
		begin
