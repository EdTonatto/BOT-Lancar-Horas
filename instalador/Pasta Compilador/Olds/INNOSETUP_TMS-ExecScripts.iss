...
#define MyAppVersion "Atualizacao_AtualizaPROCEDURE"
...
OutputBaseFilename=Atualizacao_AtualizaPROCEDURE
...
begin
  ...
  begin
		...
		begin
			...
			ShellExec('', ExpandConstant('{tmp}\Executor.exe'), ExpandConstant('"{tmp}\Scripts\Scripts.sql" "Script_Cotacao"'), '', SW_SHOW, ewWaitUntilTerminated, ErrorCode);
