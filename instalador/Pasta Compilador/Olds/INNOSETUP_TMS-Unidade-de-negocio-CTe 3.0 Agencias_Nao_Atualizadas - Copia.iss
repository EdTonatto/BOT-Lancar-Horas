...
#define MyAppVersion "Atualização TMS - Unidade de Negócio - Versão 6.0.3.9"
...
OutputBaseFilename=Atualizacao_TMS-unidade-de-negocio_6.0.3.9
...
Source: ..\Projeto - Arquivos\Scripts_cte\*; DestDir: \Scripts\; Flags: ignoreversion dontcopy; Languages:
Source: ..\Projeto - Arquivos\Scripts_cte_log\*; DestDir: \Scripts_log\; Flags: ignoreversion dontcopy; Languages:
...
begin
  ...
  begin
		...
		begin
			...
			ShellExec('', ExpandConstant('{tmp}\Executor.exe'), ExpandConstant('"{tmp}\Scripts_log\sql_log.sql"'), '', SW_SHOW, ewWaitUntilTerminated, ErrorCode);		
